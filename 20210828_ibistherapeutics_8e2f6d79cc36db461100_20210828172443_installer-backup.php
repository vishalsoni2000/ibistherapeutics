...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210828_ibistherapeutics_8e2f6d79cc36db461100_20210828172443_archive.zip';
	const ARCHIVE_SIZE		 = '56216329';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8e2f6d7-28172443';
    const SECONDARY_PACKAGE_HASH = '4cd7729-28172443';
	const VERSION			 = '1.4.2';
